...
Source0  : https://cpan.metacpan.org/authors/id/G/GF/GFRANKS/Test-MockModule-v0.177.0.tar.gz
...
%prep
%setup -q -n Test-MockModule-v0.177.0
cd %{_builddir}
tar xf %{_sourcedir}/libtest-mockmodule-perl_0.170.0-1.debian.tar.xz
cd %{_builddir}/Test-MockModule-v0.177.0
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Test-MockModule-v0.177.0/deblicense/
...
cp %{_builddir}/Test-MockModule-v0.177.0/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-MockModule/7d360f7baeca6fed9ac9466dc982ae852c71dedf
...
/usr/share/package-licenses/perl-Test-MockModule/7d360f7baeca6fed9ac9466dc982ae852c71dedf
/usr/share/package-licenses/perl-Test-MockModule/df4957f7d747e74e0bfa20d6b99a2fac98bb9753

%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/Test/MockModule.pm
