...
Source0  : https://cpan.metacpan.org/authors/id/G/GF/GFRANKS/Test-MockModule-v0.174.0.tar.gz
...
%prep
%setup -q -n Test-MockModule-v0.174.0
cd %{_builddir}
tar xf %{_sourcedir}/libtest-mockmodule-perl_0.170.0-1.debian.tar.xz
cd %{_builddir}/Test-MockModule-v0.174.0
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Test-MockModule-v0.174.0/deblicense/
...
cp %{_builddir}/Test-MockModule-v0.174.0/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-MockModule/84cb5dbf9d7b11631985795af75799605afec051
